...
fun FormularioAnimal(
    ...
    Column(
        ...
        Text("Paso 2: Datos de Animal", style = MaterialTheme.typography.headlineSmall)
        ...
        OutlinedTextField(
            ...
            label = { Text("Descripción de la especie") }
        )
        ...
        Button(onClick = {
            ...
            if (
                rarezaSeleccionada == null || descripcionEspecie.isBlank() ||
