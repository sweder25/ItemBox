...
@Composable
fun CrearInventarioPage(inventarioViewModel: InventarioViewModel, onInventarioCreado: () -> Unit) {
    var nombre by remember { mutableStateOf("") }
    var dinero by remember { mutableStateOf("") }

    Column(modifier = Modifier.padding(16.dp)) {
        Text("Crear nuevo inventario", style = MaterialTheme.typography.headlineSmall)
